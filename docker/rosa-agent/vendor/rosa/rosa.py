...
class ROSA:
    ...
    def __init__(
        ...
        # Tool-selection/execution trace of the most recent invoke() call.
        # Only populated when return_intermediate_steps=True.
        self.last_intermediate_steps = []
    ...
    def invoke(self, query: str) -> str:
        ...
        self.last_intermediate_steps = result.get("intermediate_steps", [])
