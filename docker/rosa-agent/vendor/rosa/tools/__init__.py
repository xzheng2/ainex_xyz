...
class ROSATools:
    def __init__(
        ...
        # NOTE: the built-in log package (log.py / read_log) is intentionally NOT
        # registered — Ainex BT/ROS log analysis is handled by the xyz custom tools.
        from . import calculation, system
