#!/usr/bin/env python3
"""XyzBTRunner -- BT lifecycle manager with run-complete publishing."""
import uuid
import rospy
import py_trees
from py_trees.common import Status
from xyz_bt_lib.core.base_node import XyzBTNode
from xyz_bt_lib.msg import BTRunComplete


class XyzBTRunner:
    """
    Manages a BT's full lifecycle:
    - Injects session_id into all XyzBTNode instances at init
