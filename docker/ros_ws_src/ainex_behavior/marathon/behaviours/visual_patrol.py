#!/usr/bin/env python3
# encoding: utf-8
# Local copy of visual patrol for marathon behaviours package.
# Copied from hurocup2025/scripts/marathon/visual_patrol.py so that
# marathon_bt_node.py does not depend on the hurocup2025 rospkg path lookup.
# gait_manager may be a ManagerProxy — set_step() calls are automatically traced.
import math
