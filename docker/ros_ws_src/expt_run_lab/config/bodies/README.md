...
`expt_run_lab/run_lab/run_context.py: resolve_body_id()` resolves in this order:
...
1. On the new robot, read its AP name: `python3 …/expt_run_lab/run_lab/run_context.py`
