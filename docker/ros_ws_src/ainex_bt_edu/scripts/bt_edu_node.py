#!/usr/bin/env python3
"""
Example: Run a behavior tree using ainex_bt_edu.
...
from ainex_bt_edu import AinexBTRunner, BlackboardROSBridge, BB
from ainex_bt_edu.behaviours.L1_perception import (
    L1_Battery_IsVoltageOk,
    L1_Vision_IsLineDetected,
)
from ainex_bt_edu.behaviours.L2_locomotion import (
    L2_Gait_FollowLine,
    L2_Gait_Stop,
)
...
def build_dry_run_tree():
    ...
    from ainex_bt_edu.behaviours.L1_perception import L1_Balance_IsStanding
