...
class ApriltagTrackNode(Common):
	...
	#change x_amplitude under here !!!
        self.gait_manager.set_step(self.gait_param_dsp, 0.03, 0, self.turn, self.gait_param, arm_swap=50, step_num=0)
    ...
    def run(self):
        ...
        self.gait_manager.set_step(self.gait_param_dsp, 0, 0, 0, self.gait_param, arm_swap=30, step_num=1)
        self.gait_param_dsp = [210, 0.2, 0.02]
        self.gait_manager.set_step(self.gait_param_dsp, -0.021, 0, 0, self.gait_param, arm_swap=30, step_num=15)
