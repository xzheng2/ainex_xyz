...
class ApproachObject:
    ...
    def process(self, max_y, center_x, angle, x_stop, y_stop, yaw_stop, width, height):
        ...
        if abs(angle) <= self.yaw_approach_value:
            yaw_output = 0
        #print("angle: {}, yaw_stop: {}, yaw_output: {}".format(angle, yaw_stop, yaw_output))
