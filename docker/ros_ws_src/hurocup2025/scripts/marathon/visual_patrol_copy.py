...
class VisualPatrol:
    def __init__(self, gait_manager):
        ...
        self.go_gait_param['body_height'] = 0.03
        self.go_gait_param['step_height'] = 0.02
        self.go_gait_param['init_y_offset'] = 0.0
        self.go_gait_param['hip_pitch_offset'] = 18
        self.go_gait_param['z_swap_amplitude'] = 0.006
        self.go_dsp = [330, 0.2, 0.025]
        self.go_arm_swap = 50

        self.turn_gait_param = self.gait_manager.get_gait_param()
        self.turn_gait_param['body_height'] = 0.03
        self.turn_gait_param['step_height'] = 0.02
        self.turn_gait_param['hip_pitch_offset'] = 18
        self.turn_gait_param['z_swap_amplitude'] = 0.006
        self.turn_dsp = [330, 0.2, 0.02]
        self.turn_arm_swap = 50
