...
# Both scripts live in the same directory; ensure it is on sys.path
_HERE = os.path.dirname(os.path.abspath(__file__))
if _HERE not in sys.path:
    sys.path.insert(0, _HERE)

from color_detection_min import ColorDetectionMin
...
class ColorDetectionMinNode:
    ...
    def run(self):
        ...
        while self.running and not rospy.is_shutdown():
            ...
            self.pub_image.publish(common.cv2_image2ros(annotated))
