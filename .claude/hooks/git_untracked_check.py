#!/usr/bin/env python3
"""PostToolUse hook: after git commit, warn about untracked files in ros_ws_src and rosa-agent."""
import json
import subprocess
import sys
...
def main():
    ...
    try:
        result = subprocess.run(
            ["git", "-C", "/home/pi", "status", "--short", "--",
             "docker/ros_ws_src/", "docker/rosa-agent/"],
    ...
    context = (
        ...
        f"in docker/ros_ws_src/ or docker/rosa-agent/:\n"
        f"{files}\n"
