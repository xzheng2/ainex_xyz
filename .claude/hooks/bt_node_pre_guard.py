#!/usr/bin/env python3
"""PreToolUse hook: inject ainex-bt-project skill reminder before writing a BT node file."""
import json
import re
import sys
...
_REMINDER = (
    "【BT节点守护 · 事前提醒】\n"
    "检测到即将写入 ainex_behavior .../behaviours/*.py BT节点文件。\n"
    "请确保内容符合 AinexBTNode 规范（ainex-bt-project skill）：\n"
    ...
    "如需规范模板，请先调用 ainex-bt-project skill 再写代码。"
)
