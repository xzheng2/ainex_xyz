...
| T23 | `/<proj>_bt/log/tree` | `py_trees_msgs/BehaviourTree` | `<proj>_bt` | rqt_py_trees, ROSA | per tick (30 Hz), latched | Full BT snapshot for rqt visualization |
| T24 | `/<proj>_bt/ascii/snapshot` | `std_msgs/String` | `<proj>_bt` | ROSA, debug | per tick, latched | Human-readable ASCII tree rendering |
| T25 | `/<proj>_bt/tip` | `py_trees_msgs/Behaviour` | `<proj>_bt` | ROSA, debug | per tick, latched | Current tip (deepest active) node |
| T26 | `/bt/<proj>/bb/robot_state` | `std_msgs/String` | `<proj>_bt` | ROSA | 10 Hz, latched | BB mirror: 'stand', 'lie_to_stand', 'recline_to_stand' (JSON) |
