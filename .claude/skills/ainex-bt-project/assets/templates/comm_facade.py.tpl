...
All outbound ROS communications from {{PROJECT_CLASS}} BT leaf nodes flow through
this class via the Project Semantic Facade.  Every method:
...
class CommFacade:
    """Unified ROS communication exit for {{PROJECT_CLASS}} BT."""
    ...
    def set_step(self, bt_node=None, semantic_source=None, tick_id=None, *,
        ...
        self._emit(bt_node, semantic_source or 'set_step',
                   ...
                   'ainex_controller',
                   {'dsp': dsp, 'x': x, 'y': y, 'yaw': yaw}, tick_id=tick_id)
